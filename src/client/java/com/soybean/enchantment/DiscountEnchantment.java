    ...
    public static void registerEvents() {
        AttackEntityCallback.EVENT.register((player, world, hand, entity, hitResult) -> {
            if (!world.isClient && entity instanceof Merchant) {
                ...
                if (EnchantmentHelper.getLevel(EnchantseriesClient.DISCOUNT_ENCHANTMENT, weapon) > 0) {
                ...
                //快速进货
                if (EnchantmentHelper.getLevel(EnchantseriesClient.FAST_STOCK_ENCHANTMENT, weapon) > 0) {
